        ...
        <div class="card-body">
            ...
            <div class="table">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php $i = 1; ?>
                        <?php foreach ($data_riwayat_pertumbuhan as $item) : ?>
                            <tr>
                                <th scope="row"><?= $i++ ?></th>
                                <td><?= $item['nama_anak']; ?></td>
                                <td><?= $item['judul_riwayat_pertumbuhan']; ?></td>
                                <td><?= $item['tanggal_riwayat_pertumbuhan']; ?></td>
                                <td>
                                    <a href="riwayat-pertumbuhan-detail/<?= $item['slug_riwayat_pertumbuhan'] ?>" class="btn btn-info mb-1"><i class="fa fa-eye"></i> Detail</a>
                                    <!-- <a href="riwayat-pertumbuhan-ubah/<?= $item['slug_riwayat_pertumbuhan'] ?>" class="btn btn-warning mb-1"><i class="fa fa-pen"></i> Ubah</a> -->
                                    <form action="riwayat-pertumbuhan-hapus/<?= $item['riwayat_pertumbuhan_id'] ?>" method="post" class="mb-1 d-inline">
                                        <?= csrf_field() ?>
