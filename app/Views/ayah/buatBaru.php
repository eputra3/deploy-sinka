...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Buat Baru Ayah</h1>
    <p class="mb-4">Data Master Pembuatan Ayah Baru</p>
    <!-- Card detail artikel -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulir Ayah Baru</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col">
            ...
            <form action="<?= route_to('simpan-ayah') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3 row">
                            <label for="" class="col-sm-4 col-form-label">Identitas Ayah</label>
                            <div class="col-sm">
                        ...
                        <div class="mb-3 row">
                            <label for="" class="col-sm-4 col-form-label">Tempat Lahir Ayah</label>
                            <div class="col-sm">
                        ...
                        <div class="mb-3 row">
                            <label for="" class="col-sm-4 col-form-label">Email Ayah</label>
                            <div class="col-sm">
                        ...
                        <div class="mb-3 row">
                            <label for="" class="col-sm-4 col-form-label">Nomor HP Ayah</label>
                            <div class="col-sm">
                        ...
                        <div class="mb-3 row">
                            <label for="" class="col-sm-4 col-form-label">Penghasilan Ayah</label>
                            <div class="col-sm">
                        ...
                        <div class="mb-3 row">
                            <label for="" class="col-sm-4 col-form-label">Alamat Ayah</label>
                            <div class="col-sm">
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="alamat_ayah" rows="3" placeholder="<?= old('alamat_ayah') ?>"></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="formFile" class="col-sm-4 col-form-label">Gambar Identitas Ayah</label>
                            <div class="col-sm-4">
