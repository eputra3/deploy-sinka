...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulir Perubahan Data Ayah</h6>
        </div>
        <div class="card-body">
        ...
        <div class="container-fluid">
            <form action="<?= route_to('perbaharui-ayah', $result['ayah_id']) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <label for="identitas_ayah" class="col-sm-4 col-form-label">Identitas</label>
                    <div class="col-sm">
                ...
                <div class="row mb-3">
                    <label for="nama_ayah" class="col-sm-4 col-form-label">Nama Lengkap</label>
                    <div class="col-sm">
                ...
                <div class=" row mb-3">
                    <label for="tempat_lahir_ayah" class="col-sm-4 col-form-label">Tempat Lahir</label>
                    <div class="col-sm">
                ...
                <div class="row mb-3">
                    <label for="email_ayah" class="col-sm-4 col-form-label">Email</label>
                    <div class="col-sm">
                ...
                <div class="row mb-3">
                    <label for="no_hp_ayah" class="col-sm-4 col-form-label">Nomor HP</label>
                    <div class="col-sm">
                ...
                <div class="row mb-3">
                    <label for="penghasilan_ayah" class="col-sm-4 col-form-label">Penghasilan</label>
                    <div class="col-sm">
                ...
                <div class=" row mb-3">
                    <label for="alamat_ayah" class="col-sm-4 col-form-label">Alamat Lengkap</label>
                    <div class="col-sm">
                ...
                <div class="row mb-3">
                    <label for="gambar_identitas_ayah" class="col-sm-4 col-form-label">Foto Identitas</label>
                    <div class="col-sm">
