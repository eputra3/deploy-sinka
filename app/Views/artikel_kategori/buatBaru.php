...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Kategori Artikel</h1>
    <!-- <p class="mb-4">Data Master Pembuatan Kategori Artikel Baru</p> -->
    <!-- DataTales Example -->
    <!-- <div class="row"> -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulir Buat Data Baru Kategori Artikel</h6>
        </div>
        <div class="card-body">
        ...
        <div class="container-fluid">
            <!-- Form Data -->
            <form action="<?= route_to('simpan-artikel-kategori') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="row mb-3">
                    <label for="nama_artikel_kategori" class="col-sm-2 col-form-label">Nama</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= $validation->hasError('nama_artikel_kategori') ? 'is-invalid' : '' ?>" id="text" name="nama_artikel_kategori" value="<?= old('nama_artikel_kategori') ?>">
