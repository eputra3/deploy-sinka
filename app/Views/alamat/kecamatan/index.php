            ...
            <div class="col">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">List Kecamatan</h6>
                    </div>
                    <div class="card-body">
                        <a href="kecamatan-buat-baru" class="btn btn-success mb-2"><i class="fa fa-plus-circle"></i> Tambah Kecamatan</a>
                        <div class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data_kecamatan as $value) : ?>
                                        <tr>
                                            ...
                                            <td><img src="/img/<?= $value['gambar_kecamatan']; ?>   " alt="" width="75px"></td>
                                            <td>
                                                <a href="kecamatan-ubah/<?= $value['slug_kecamatan'] ?>" class="btn btn-warning mb-1 mt-1"><i class="fa fa-pen"></i> Ubah</a>
                                                <form action="kecamatan-hapus/<?= $value['kecamatan_id'] ?>" method="post" class="mb-1 d-inline">
                                                    <?= csrf_field() ?>
