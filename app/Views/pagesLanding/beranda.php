        ...
        <div class="row gx-5 align-items-center justify-content-center">
            <div class="col-lg-8 col-xl-7 col-xxl-6">
                <div class="my-5 text-center text-xl-start">
                    <h1 class="display-5 fw-bolder text-white mb-2">Sistem Informasi Kesehatan Ibu dan Anak</h1>
                    <p class="lead fw-normal text-white mb-4">SINKA (Sistem Informasi Kesehatan Ibu dan Anak) merupakan aplikasi informasi dan edukasi terkait kesehatan Ibu dan Anak untuk mengatasi stunting di Provinsi Nusa Tenggara Timur (NTT).</p>
